...
import diffusers
from diffusers import DDPMPipeline, DDPMScheduler, UNet2DConditionModel, AutoPipelineForText2Image
from diffusers.optimization import get_scheduler 
from diffusers.training_utils import EMAModel
from diffusers.utils import check_min_version, is_accelerate_version, is_tensorboard_available, is_wandb_available
from CustomText2ImgPipeline import TextToImagePipeline 
    ...
    for epoch in range(first_epoch, args.num_epochs):
        ...
        if accelerator.is_main_process:
            if epoch % args.save_images_epochs == 0 or epoch == args.num_epochs - 1:
                ...
                sample_prompts  = [
                "a pixel art character with square white glasses, a teacup-shaped head and a lavender-colored body on a warm background",
                "a pixel art character with square purple glasses, a marshmallow-shaped head and a lime-colored body on a cool background",
                "a pixel art character with square turquoise glasses, a guitar-shaped head and a peach-colored body on a warm background",
                "a pixel art character with square black glasses, a donut-shaped head and a crimson-colored body on a cool background",
                "a pixel art character with square silver glasses, a skyscraper-shaped head and a lightblue-colored body on a warm background",
                "a pixel art character with square maroon glasses, a surfboard-shaped head and a sandy-colored body on a cool background",
                "a pixel art character with square teal glasses, a coffee mug-shaped head and a mustard-colored body on a warm background",
                "a pixel art character with square lavender glasses, a jellybean-shaped head and a coral-colored body on a cool background",
                "a pixel art character with square emerald glasses, a balloon-shaped head and a lilac-colored body on a warm background",
                "a pixel art character with square gold glasses, a kite-shaped head and a pinkish-gray-colored body on a cool background",]
